...
public class User {
   ...
   private List<Produit> produits;
    ...
    public User(String nom, String password, String email, String pays, String gouvernorat, String ville, String rue, String tel, String permistravail, Integer bloque, Integer demande_acces, String roles) {
        this.nom = nom;
        this.password = password;
        this.email = email;
        this.pays = pays;
